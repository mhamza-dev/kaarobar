...
import { BrandThemeProvider } from "../lib/BrandThemeContext";
        ...
        <CartProvider>
          ...
          <Stack
            screenOptions={{
              ...
              headerTitleStyle: { fontWeight: "700", color: colors.heading },
          ...
          >
            ...
            <Stack.Screen name="app/checkout/pay" options={{ title: "Checkout" }} />
          </Stack>
        </CartProvider>
      </BrandThemeProvider>
    </ToastProvider>
