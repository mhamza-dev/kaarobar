      ...
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        ...
        {tab === "subscriptions" && owner && sub ? (
          <View style={styles.section}>
            ...
            <Pressable style={styles.linkCard} onPress={() => pushPath(navigation, "/app/businesses")}>
