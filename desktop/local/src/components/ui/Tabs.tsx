...
export type TabsProps = {
  ...
  className?: string
  /**
   * Stable id prefix so the page can render matching `${idBase}-panel-<id>`
   * tab panels; falls back to an auto-generated id when panels don't need it.
   */
  idBase?: string
}

export function Tabs({ items, value, onValueChange, className, idBase }: TabsProps) {
  const autoId = useId()
