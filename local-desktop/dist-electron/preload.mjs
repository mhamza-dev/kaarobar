...
const api = {
  ...
  auth: {
    ...
    verifyPassword: (password) => electron.ipcRenderer.invoke(IPC_CHANNELS.AUTH_VERIFY_PASSWORD, password)
  },
  business: {
  ...
  printer: {
    ...
    preview: (payload) => electron.ipcRenderer.invoke(IPC_CHANNELS.PRINTER_PREVIEW, payload)
  },
  sales: {
