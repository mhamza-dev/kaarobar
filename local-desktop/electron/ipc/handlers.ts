...
import type { PrinterTestKind, ReceiptPreviewPayload } from '../../shared/types/api'
import {
...
import { getSession, login, logout, resetOwnerPasswordOffline, verifySessionPassword } from '../auth/service'
...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle(IPC_CHANNELS.AUTH_VERIFY_PASSWORD, async (_event, password: string) =>
    verifySessionPassword(password),
  )
  ...
  ipcMain.handle(IPC_CHANNELS.PRINTER_PREVIEW, async (_event, payload: ReceiptPreviewPayload) =>
