# Kaarobar brand assets

Canonical modular “K” logo (connectivity / multi-branch). Geometry is the product SVG (1024×1024, `#2d6df6` tile).
...
**Brand blue:** `#2d6df6` (icon tile). App UI `--brand` may remain `#1d4ed8` for chrome; logo tile follows this SVG.
