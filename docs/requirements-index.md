...
| ADM-FR | Platform Admin & Billing | §5.8 | Plan limits + **Safepay** webhook/checkout Must; **ADM-FR-007** Offline one-time license Must |
...
| ADM-FR-002/003 | Plan limits + **Safepay** webhook/checkout (Pakistan / Cloud) |
...
| OFF-FR-001–004/006 | Cloud Desktop cache, outbox, idempotent sync, delta stock, FBR queue |
| ODE-FR-001–014 | Single shop, SQLite, license-then-offline, EN/UR RTL, vertical POS, checkout, catalog/PO, khata, RBAC, branding, encrypted backup, lockout/reminders, installers |
