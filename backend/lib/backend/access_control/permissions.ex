defmodule Kaarobar.AccessControl.Permissions do
  ...
  @catalogue [
    ...
    {:customers, "payment:view", "View gateway payments"},
    {:customers, "payment:charge", "Take a payment through a gateway"},
    {:customers, "payment:refund", "Refund a gateway payment"},
    {:customers, "payment:configure", "Configure payment gateways"},
    {:customers, "payment:reconcile", "Reconcile gateway payouts against the bank"},
    ...
    {:verticals, "rental:view", "View rental stock and agreements"},
    {:verticals, "rental:manage", "Manage rental agreements"},
    {:verticals, "quote:view", "View quotes"},
    {:verticals, "quote:manage", "Draw up and send quotes"},
    {:verticals, "time_entry:view", "View recorded time"},
    {:verticals, "time_entry:record", "Record time worked"},
    {:verticals, "regulated:view", "Read the regulated-goods register"},
