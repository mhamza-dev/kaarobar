  ...
  return (
    <section className="relative overflow-hidden surface-mesh surface-noise">
      ...
      <div className="absolute inset-0">
        <div className="absolute left-1/2 top-0 h-162.5 w-162.5 -translate-x-1/2 rounded-md bg-brand/15 blur-[120px]" />
        <div className="absolute left-16 top-40 h-64 w-64 rounded-md bg-accent/15 blur-[120px]" />
        <div className="absolute bottom-0 right-16 h-80 w-80 rounded-md bg-info/15 blur-[140px]" />
      </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              return (
                <div
                  key={card.title}
                  className="rounded-md border border-border bg-card/90 p-5 shadow-sm backdrop-blur"
                >
