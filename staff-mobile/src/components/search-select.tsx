...
function createStyles(t: Theme) {
  return StyleSheet.create({
    ...
    triggerText: { color: t.heading, fontSize: 14 },
    ...
    empty: { color: t.muted, padding: 12, textAlign: "center" },
    row: {
      flexDirection: "row",
      alignItems: "center",
      gap: 10,
    ...
    rowOn: { backgroundColor: `${t.brand}18` },
    rowText: { flex: 1, color: t.heading, fontSize: 14 },
